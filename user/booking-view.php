      ...
      <div class="col-md-7">
        ...
        <div class="mb-2">
          <?php if (!empty($booking['invoice_url'])): ?>
            <a href="<?= htmlspecialchars($booking['invoice_url']) ?>" class="btn btn-info me-2" target="_blank">Download Invoice</a>
          <?php else: ?>
            <a href="#" class="btn btn-info disabled me-2" style="pointer-events:none;">Download Invoice</a>
          <?php endif; ?>
