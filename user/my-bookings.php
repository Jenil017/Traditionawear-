        ...
        <div class="card p-4 mb-3 shadow-sm">
            <div class="row">
                ...
                <div class="col-md-3 d-flex flex-column align-items-end justify-content-center">
                    ...
                    <a href="#" class="btn btn-info disabled" style="pointer-events:none;">Download Invoice</a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 d-flex flex-column align-items-end justify-content-center">
                        ...
                        <?php if (!empty($booking['invoice_url'])): ?>
                            <a href="<?= htmlspecialchars($booking['invoice_url']) ?>" class="btn btn-info mb-2" target="_blank">Download Invoice</a>
                        <?php else: ?>
                            <a href="#" class="btn btn-info disabled mb-2" style="pointer-events:none;">Download Invoice</a>
                        <?php endif; ?>
