                    ...
                    try {
                        ...
                        if (empty($contacts)) {
                            ...
                            foreach ($contacts as $contact) {
                                ...
                                echo "<button class='btn btn-outline-info' onclick='viewMessage(" . $contact['id'] . ")' title='View Full Message'>";
                                echo "<i class='fas fa-eye'></i>";
                                echo "</button>";
                                echo "<a href='mailto:" . htmlspecialchars($contact['email']) . "' class='btn btn-outline-success' title='Reply via Email'>";
                                echo "<i class='fas fa-reply'></i>";
                                echo "</a>";
                                echo "<a href='contact-delete.php?id={$contact['id']}' class='btn btn-outline-danger' onclick='return confirm(\"Are you sure you want to delete contact from: " . htmlspecialchars($contact['name']) . "?\")' title='Delete'>";
